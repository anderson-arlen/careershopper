...
Personal context supplies confirmed interests, domain connections and credentials for matching and tailored prose. Use its short IDs as support, but do not add a fixed personal-context resume section or force unrelated interests into a letter.
Core skills supply proficiency and context as evidence, not fixed resume paragraphs. Respect the saved proficiency and limitations; never imply equal proficiency or upgrade experience. Use their short IDs in support_ids for generated skill groups, summaries and letters.
